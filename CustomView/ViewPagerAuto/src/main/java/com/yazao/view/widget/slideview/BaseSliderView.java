package com.yazao.view.widget.slideview;
    ...
    protected void loadByPicasso(final View v, ImageView targetImageView) {
        ...
        rq.into(targetImageView, new Callback() {
            ...
            public void onSuccess() {
            	// 图片下载成功
//            	GlobalParams.PC_WALLET_AD_FLAG=true;
//                if (v.findViewById(MResource.getIdByName(getContext(), "id", "ag_loading_bar")) != null) {
//                    v.findViewById(MResource.getIdByName(getContext(), "id", "ag_loading_bar")).setVisibility(View.INVISIBLE);
//                }
            ...
            public void onError() {
            	// 图片下载失败
//            	GlobalParams.PC_WALLET_AD_FLAG=false;
                if (mBitmapLoadListener != null) {
