...
import com.yazao.android.view.util.MyUtils;
...
public class CircleBarView extends View {
	...
	/**
	 * 为了达到数字增加效果而添加的变量，他和mText其实代表一个意思
	 */
	private int mCount;
	/**
	...
	protected void onDraw(Canvas canvas) {
		...
		Log.i("YaZao","bounds.height()= "+bounds.height());
	}
	...
	public class BarAnimation extends Animation {
		 ...
		 *  type The type of animation: 0 will expand from gone and 0 size to visible and layout size defined in xml.
